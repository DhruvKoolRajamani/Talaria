...
namespace joint_states_settler
{
  ...
  class ConfigGoal : public ros::Msg
  {
    public:
      ...
      typedef double _tolerances_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->tolerances_length >> (8 * 3)) & 0xFF;
      ...
      u_tolerancesi.real = this->tolerances[i];
      *(outbuffer + offset + 0) = (u_tolerancesi.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_tolerancesi.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_tolerancesi.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_tolerancesi.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_tolerancesi.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_tolerancesi.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_tolerancesi.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_tolerancesi.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->tolerances[i]);
      }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(tolerances_lengthT > tolerances_length)
        this->tolerances = (double*)realloc(this->tolerances, tolerances_lengthT * sizeof(double));
      ...
      u_st_tolerances.base = 0;
      u_st_tolerances.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_tolerances.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_tolerances.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_tolerances.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_st_tolerances.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_st_tolerances.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_st_tolerances.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_st_tolerances.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->st_tolerances = u_st_tolerances.real;
      offset += sizeof(this->st_tolerances);
        memcpy( &(this->tolerances[i]), &(this->st_tolerances), sizeof(double));
      }
